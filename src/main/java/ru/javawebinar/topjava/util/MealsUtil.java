...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2015, Month.MAY, 29, 10, 0), "Завтрак", 100,2),
            new Meal(LocalDateTime.of(2015, Month.MAY, 29, 13, 0), "Обед", 200,2),
            new Meal(LocalDateTime.of(2015, Month.MAY, 29, 20, 0), "Ужин", 100,2),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000,1),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 2000,1),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 1000,1)
    );
